...
Output:
- `keycap_1u_hollow_bottom_no_stem.stl`
- `keycap_1u_hollow_bottom_no_stem_bottom.png`
- `keycap_1u_hollow_bottom_no_stem_bottom_clean.png`
- `keycap_1u_hollow_bottom_no_stem_side.png`
